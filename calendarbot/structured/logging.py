...
class StructuredFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        log_entry = {
            'timestamp': datetime.fromtimestamp(record.created).strftime(self.timestamp_format)[:-3],
...
class StructuredLogger:
    ...
    def error(self, message: str, context: Optional[LogContext] = None,
             extra: Optional[Dict[str, Any]] = None, exc_info: Optional[Any] = None):
        """Log error message."""
    ...
    def audit(self, message: str, context: Optional[LogContext] = None,
             extra: Optional[Dict[str, Any]] = None):
        """Log audit message."""
...
@contextmanager
def operation_context(operation: str, component: Optional[str] = None,
                     correlation_id: Optional[Union[str, CorrelationID]] = None,
                     **kwargs):
    """
...
def get_structured_logger(name: str = 'calendarbot.structured', 
                         settings: Optional[Any] = None) -> StructuredLogger:
