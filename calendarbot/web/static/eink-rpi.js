/* ===========================================
   ...
   Optimized for 480x800px e-ink displays (portrait)
   =========================================== */
...
/**
 * Setup optimized event handling for e-ink displays (status updates only)
 */
...
// Navigation functions removed - display is now status-only without navigation

// ===========================================
// STATUS UPDATE FUNCTIONS
// ===========================================

// Navigation function removed - display is now status-only
...
/**
 * Show status update feedback optimized for e-ink
 * @param {string} message - Status message
 */
function showEInkStatusFeedback(message) {
    // For e-ink displays, provide minimal visual feedback
    const statusDisplay = document.querySelector('.calendar-status');
    if (statusDisplay) {
...
// Export status-only functions for global access
window.toggleTheme = toggleTheme;
window.refresh = refresh;
window.EInkCalendar = EInkCalendar;

// Override any existing calendarBot object (navigation removed)
window.calendarBot = {
    toggleTheme,
    refresh,
