...
from ..cache.models import CalendarEvent
from ..cache import CacheManager
from .models import SourceConfig, SourceInfo, SourceType, SourceStatus
...
class SourceManager:
    ...
    def __init__(self, settings, cache_manager: Optional[CacheManager] = None):
    ...
    async def add_ics_source(self, name: str, url: str, 
        ...
        try:
            ...
            if self.cache_manager and all_events:
                ...
                if cache_success:
                    ...
                    self._consecutive_failures = 0
                    logger.info(f"Successfully cached {len(all_events)} events from {successful_sources} sources")
                    return True
                else:
