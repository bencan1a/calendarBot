...
class ICSValidationResult(BaseModel):
    ...
    def is_valid(self) -> bool:
        ...
        return (self.source_accessible and
                self.auth_valid and
...
class Attendee(BaseModel):
    ...
    response_status: ResponseStatus = Field(default=ResponseStatus.NOT_RESPONDED, description="Response status")
...
class CalendarEvent(BaseModel):
    ...
    last_modified_date_time: Optional[datetime] = Field(default=None, description="Last modification time")
