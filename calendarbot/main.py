...
class CalendarBot:
    ...
    async def update_display(self, force_cached: bool = False) -> bool:
        ...
        try:
            ...
            status_info = {
                ...
                'connection_status': 'Online' if not force_cached and not cache_status.is_stale else 'Offline',
    ...
    async def handle_error_display(self, error_message: str):
        ...
        try:
            ...
            cached_events = await safe_async_call(
                self.cache_manager.get_todays_cached_events,
                default=[],
                log_errors=False
            )
        ...
        try:
            ...
            if not is_cache_fresh:
                ...
                if not fetch_success:
                    ...
                    await self.handle_error_display(
    ...
    async def run_background_fetch(self):
        ...
        logger.info(f"Starting background data fetching (interval: {self.settings.refresh_interval}s)")
            ...
            while self.running and not self.shutdown_event.is_set():
                try:
                    ...
                    await asyncio.wait_for(
                        ...
                        timeout=self.settings.refresh_interval
                    )
