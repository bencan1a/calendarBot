...
class InteractiveController:
    ...
    async def _update_display(self):
        ...
        try:
            ...
            logger.info(f"DEBUG: Querying events for {selected_date} between {start_datetime} and {end_datetime}")
        ...
        while self._running:
            try:
                ...
                if (self._last_data_update is None or 
                    (cache_status.last_update and 
                     cache_status.last_update != self._last_data_update)):
    ...
    async def get_events_for_week(self, target_date: date) -> Dict[date, List[CachedEvent]]:
        ...
        try:
            ...
            all_events = await self.cache_manager.get_events_by_date_range(start_datetime, end_datetime)
