...
class ValidationResults:
    ...
    def add_result(self, 
        ...
        Args:
            component: Component being tested (auth, api, cache, display)
    ...
    def add_success(self, component: str, test_name: str, message: str, 
                   details: Optional[Dict[str, Any]] = None, duration_ms: Optional[int] = None) -> None:
        """Add a successful validation result."""
        self.add_result(component, test_name, ValidationStatus.SUCCESS, message, details, duration_ms)
    
    def add_failure(self, component: str, test_name: str, message: str, 
                   details: Optional[Dict[str, Any]] = None, duration_ms: Optional[int] = None) -> None:
        """Add a failed validation result."""
        self.add_result(component, test_name, ValidationStatus.FAILURE, message, details, duration_ms)
    
    def add_warning(self, component: str, test_name: str, message: str, 
                   details: Optional[Dict[str, Any]] = None, duration_ms: Optional[int] = None) -> None:
        """Add a warning validation result."""
        self.add_result(component, test_name, ValidationStatus.WARNING, message, details, duration_ms)
    
    def add_skipped(self, component: str, test_name: str, message: str, 
    ...
    def print_console_report(self, verbose: bool = False) -> None:
        ...
        if verbose or self.has_failures() or self.has_warnings():
            ...
            for item in self.items:
                ...
                print(f"  {status_icon} {item.component}.{item.test_name}: {item.message}{duration_str}")
