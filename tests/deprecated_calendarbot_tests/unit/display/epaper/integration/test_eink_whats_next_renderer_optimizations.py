    ...
    with patch(
        ...
        with patch(
            ...
            with patch(
                ...
                mock_get_layout.return_value = {"width": 400, "height": 300}
                    ...
                    with patch.object(mock_renderer, "_render_full_image") as mock_render_full:
                        ...
                        with patch(
                            ...
                            assert mock_start.called, (
                                "Performance monitoring start_operation should be called"
                            )
                            assert mock_end.called, (
                                "Performance monitoring end_operation should be called"
                            )
                            ...
                            assert len(start_calls) > 0, (
                                "Should call start_operation with a valid operation name"
                            )
                            ...
                            assert len(end_calls) > 0, (
                                "Should call end_operation with a valid operation name"
                            )
