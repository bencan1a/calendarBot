...
def mock_html_converter():
    ...
    mock_converter.convert_url_to_png.return_value = temp_file.name
...
class TestEInkWhatsNextRendererHtml:
    ...
    def test_init_when_html2image_available_then_initializes_converter(
        ...
        with patch(
            "calendarbot.display.epaper.integration.eink_whats_next_renderer.HTML2IMAGE_AVAILABLE",
            True,
        ):
            with patch(
                "calendarbot.display.epaper.integration.eink_whats_next_renderer.create_converter"
            ) as mock_create:
    ...
    def test_render_when_html_converter_available_then_uses_html_conversion(
        ...
        with patch(
            ...
            mock_html_converter.convert_url_to_png.assert_called_once()
    ...
    def test_render_using_html_conversion_when_conversion_fails_then_falls_back_to_pil(
        ...
        mock_html_converter.convert_url_to_png.return_value = None
