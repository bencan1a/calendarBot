...
class TestBackgroundUpdateLoop:
    ...
    @pytest.mark.asyncio
    async def test_background_update_loop_when_multiple_iterations_then_sleeps_between(self) -> None:
    ...
    async def test_background_update_loop_when_exception_then_logs_and_continues(self) -> None:
        ...
        async def mock_iteration():
            ...
            if call_count == 1:
                ...
                setattr(controller, "_running", False)
    ...
    @pytest.mark.asyncio
    async def test_background_update_iteration_when_cache_updated_then_updates_display(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_background_update_iteration_when_no_timestamp_then_still_updates_today(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_background_update_iteration_when_exception_then_still_updates_today(self) -> None:
