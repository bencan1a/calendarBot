...
class TestPerformanceLogger:
    ...
    def test_log_metric(self, performance_logger: PerformanceLogger, mock_metrics_logger: MagicMock) -> None:
    ...
    def test_log_metric_exception(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        ...
        with patch("calendarbot.monitoring.performance.uuid.uuid4") as mock_uuid:
            ...
            with patch("calendarbot.monitoring.performance.time.perf_counter", return_value=100.0):
                with patch.object(performance_logger, "log_metric") as mock_log_metric:
                    timer_id = performance_logger.start_timer("test_operation", "test_component", "test-correlation-id")
    ...
    def test_stop_timer_not_found(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
    ...
    def test_log_memory_usage(self, performance_logger: PerformanceLogger) -> None:
        ...
        with patch("calendarbot.monitoring.performance.psutil.Process", return_value=mock_process):
            with patch("calendarbot.monitoring.performance.psutil.virtual_memory", return_value=mock_system_memory):
                with patch.object(performance_logger, "log_metric") as mock_log_metric:
    ...
    def test_log_memory_usage_exception(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        """Test log_memory_usage method with exception."""
        with patch("calendarbot.monitoring.performance.psutil.Process", side_effect=Exception("Test error")):
            performance_logger.log_memory_usage()
    ...
    def test_log_cache_performance_zero_requests(self, performance_logger: PerformanceLogger) -> None:
    ...
    def test_check_thresholds_request_duration_error(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        ...
        assert "Request duration critical: 15.00s exceeds 10.0s threshold" in mock_logger.error.call_args[0][0]

    def test_check_thresholds_request_duration_warning(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        ...
        assert "Request duration high: 7.50s exceeds 5.0s threshold" in mock_logger.warning.call_args[0][0]

    def test_check_thresholds_memory_usage_error(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        ...
        mock_logger.error.assert_called_once()
        assert "Memory usage critical: 1200.0MB exceeds 1000MB threshold" in mock_logger.error.call_args[0][0]

    def test_check_thresholds_memory_usage_warning(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        ...
        mock_logger.warning.assert_called_once()
        assert "Memory usage high: 750.0MB exceeds 500MB threshold" in mock_logger.warning.call_args[0][0]

    def test_check_thresholds_cache_miss_rate_error(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        ...
        metric = PerformanceMetric(
            ...
            metadata={"miss_rate": 0.7}
        )
        
        performance_logger._check_thresholds(metric)
        
        mock_logger.error.assert_called_once()
        assert "Cache miss rate critical: 70.0% exceeds 60.0% threshold" in mock_logger.error.call_args[0][0]

    def test_check_thresholds_cache_miss_rate_warning(self, performance_logger: PerformanceLogger, mock_logger: MagicMock) -> None:
        ...
        metric = PerformanceMetric(
            name="test_cache_hit_rate",
            metric_type=MetricType.CACHE,
            metadata={"miss_rate": 0.4}
        )
        
        performance_logger._check_thresholds(metric)
        
        mock_logger.warning.assert_called_once()
        assert "Cache miss rate high: 40.0% exceeds 30.0% threshold" in mock_logger.warning.call_args[0][0]
    ...
    def test_add_to_cache_limit(self, performance_logger: PerformanceLogger) -> None:
        ...
        metrics = [
            PerformanceMetric(name=f"metric_{i}")
            for i in range(5)
        ]
...
class TestPerformanceMonitorDecorator:
    ...
    def test_performance_monitor_basic(self) -> None:
        ...
        with patch("calendarbot.monitoring.performance.get_performance_logger", return_value=mock_logger):
            @performance_monitor()
            def test_function():
                return "test_result"
...
class TestGlobalFunctions:
    ...
    def test_init_performance_logging(self) -> None:
        ...
        with patch("calendarbot.monitoring.performance.PerformanceLogger", return_value=mock_logger) as mock_logger_class:
