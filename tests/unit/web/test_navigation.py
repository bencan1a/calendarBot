...
class TestWebNavigationHandler:
    ...
    def test_handle_navigation_action_when_exception_occurs_then_returns_false(self) -> None:
        ...
        with patch.object(handler.navigation_state, 'navigate_forward', side_effect=Exception("Test exception")):
            # Act
            result = handler.handle_navigation_action("next")
    ...
    def test_jump_to_date_when_exception_occurs_then_returns_false(self) -> None:
        ...
        with patch.object(handler.navigation_state, 'jump_to_date', side_effect=Exception("Test exception")):
            # Act
            result = handler.jump_to_date(target_date)
    ...
    def test_get_navigation_info_when_called_then_returns_navigation_info(self) -> None:
        ...
        with patch.multiple(
            ...
            get_week_context=MagicMock(return_value=["Jul 27", "Jul 28", "Jul 29", "Jul 30", "Jul 31", "Aug 1", "Aug 2"]),
    ...
    def test_get_navigation_info_when_exception_occurs_then_returns_error_info(self) -> None:
        ...
        with patch.object(handler.navigation_state, 'get_display_date', side_effect=Exception("Test exception")):
            # Act
            result = handler.get_navigation_info()
    ...
    def test_safe_callback_execution_when_callback_raises_exception_then_handles_gracefully(self) -> None:
    ...
    def test_selected_date_property_when_accessed_then_returns_navigation_state_selected_date(self) -> None:
    ...
    def test_is_future_when_called_then_delegates_to_navigation_state(self) -> None:
        ...
        with patch.object(handler.navigation_state, 'is_future', return_value=True) as mock_is_future:
            # Act
    ...
    def test_get_display_date_when_called_then_delegates_to_navigation_state(self) -> None:
        ...
        with patch.object(handler.navigation_state, 'get_display_date', return_value="August 2, 2025") as mock_get_display_date:
            # Act
