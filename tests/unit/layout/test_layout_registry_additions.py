...
class TestLayoutRegistryAdditionalCoverage:
    ...
    def test_discover_layouts_when_directory_not_exists_then_creates_emergency_layouts(self) -> None:
    ...
    def test_discover_layouts_when_iterdir_raises_exception_then_creates_emergency_layouts(self) -> None:
    ...
    def test_load_layout_config_when_missing_required_field_then_raises_validation_error(self) -> None:
    ...
    def test_get_layout_with_fallback_when_layout_not_exists_but_in_registry_then_uses_fallback_chain(self) -> None:
    ...
    def test_get_layout_with_fallback_when_layout_not_in_registry_then_uses_emergency_fallback(self) -> None:
