...
class TestICSSourceHandlerErrorHandling:
    ...
    def test_record_success_when_called_then_updates_metrics_and_health(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_record_failure_when_called_then_updates_metrics_and_health(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_raise_connection_error_when_called_then_records_failure_and_raises(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_raise_connection_error_when_exception_provided_then_chains_exception(self, mock_handler: ICSSourceHandler) -> None:
        ...
        # Act & Assert
        with pytest.raises(SourceConnectionError) as excinfo:
            mock_handler._raise_connection_error(f"Connection error for {mock_handler.config.name}", original_exception)
    ...
    def test_raise_data_error_when_called_then_records_failure_and_raises(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_raise_data_error_when_exception_provided_then_chains_exception(self, mock_handler: ICSSourceHandler) -> None:
        ...
        # Act & Assert
        with pytest.raises(SourceDataError) as excinfo:
            mock_handler._raise_data_error(f"Data error for {mock_handler.config.name}", original_exception)
    ...
    def test_raise_source_error_when_called_then_records_failure_and_raises(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_raise_source_error_when_exception_provided_then_chains_exception(self, mock_handler: ICSSourceHandler) -> None:
        ...
        # Act & Assert
        with pytest.raises(SourceError) as excinfo:
            mock_handler._raise_source_error(f"Source error for {mock_handler.config.name}", original_exception)
...
class TestICSSourceHandlerStatusAndMetrics:
    ...
    def test_get_status_when_called_then_returns_status_dict(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_clear_cache_headers_when_called_then_resets_headers(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_update_config_when_called_then_updates_config_and_source(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_update_config_when_url_changed_then_clears_cache_headers(self, mock_handler: ICSSourceHandler) -> None:
        ...
        with patch.object(mock_handler, "update_config", modified_update_config):
            with patch.object(mock_handler, "clear_cache_headers", wraps=mock_handler.clear_cache_headers) as mock_clear_cache:
    ...
    def test_is_healthy_when_healthy_and_enabled_then_returns_true(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_is_healthy_when_healthy_but_disabled_then_returns_false(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_is_healthy_when_unhealthy_but_enabled_then_returns_false(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_get_health_check_when_called_then_returns_health(self, mock_handler: ICSSourceHandler) -> None:
    ...
    def test_get_metrics_when_called_then_returns_metrics(self, mock_handler: ICSSourceHandler) -> None:
