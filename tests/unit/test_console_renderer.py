...
class TestConsoleRendererFormatCurrentEvent:
    ...
    def test_format_current_event_time_remaining(self, mock_now: Any) -> None:
        ...
        # Set now to be 30 minutes before event end
        event_start = datetime.now(pytz.UTC)
        event_end = event_start + timedelta(minutes=60)
        mock_now.return_value = event_end - timedelta(minutes=30)
        ...
        assert any("30 minutes remaining" in line for line in lines)
