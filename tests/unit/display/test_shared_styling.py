...
class TestSharedStylingConstants:
    ...
    def test_typography_when_accessed_then_contains_html_and_pil_formats(self) -> None:
        ...
        for key in required_keys:
            ...
            assert isinstance(typography["html"][key], str), f"HTML typography '{key}' should be a string"
        ...
        for key in required_keys:
            ...
            assert isinstance(typography["pil"][key], int), f"PIL typography '{key}' should be an integer"
    ...
    def test_typography_consistency_when_compared_to_css_then_matches_values(self) -> None:
        ...
        for key, value in css_typography.items():
            ...
            assert typography["pil"][key] == pil_value, f"PIL typography '{key}' should be numeric equivalent of CSS value"
    ...
    def test_layout_consistency_when_compared_to_css_then_matches_values(self) -> None:
        ...
        for layout_key, layout_values in css_layouts.items():
            ...
            for key, value in layout_values.items():
                ...
                assert layouts[layout_key][key] == value, f"Layout '{layout_key}.{key}' should match CSS value"


class TestSharedStylingIntegration:
    """Test the integration of SharedStylingConstants with other components."""

    def test_integration_when_imported_by_eink_renderer_then_provides_consistent_styling(self) -> None:
        ...
        from calendarbot.display.shared_styling import SharedStylingConstants, get_colors_for_renderer
        ...
        with patch("calendarbot.display.shared_styling.get_colors_for_renderer", side_effect=get_colors_for_renderer):
    ...
    def test_integration_when_imported_by_html_renderer_then_provides_consistent_styling(self) -> None:
        ...
        with patch("calendarbot.display.whats_next_renderer.SharedStylingConstants", SharedStylingConstants):
            # Create a renderer instance
