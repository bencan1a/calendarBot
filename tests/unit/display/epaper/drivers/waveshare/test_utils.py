...
class TestValidateBufferSize:
    ...
    def test_validate_buffer_size_when_incorrect_size_then_logs_error(self, mock_logger: MagicMock) -> None:
...
class TestSplitColorBuffer:
    ...
    @patch("calendarbot.display.epaper.drivers.waveshare.utils.logger")
    def test_split_color_buffer_when_invalid_size_then_logs_error(self, mock_logger: MagicMock) -> None:
...
class TestExtractRegionBuffer:
    ...
    def test_extract_region_buffer_when_valid_region_then_returns_correct_buffer(self) -> None:
        ...
        display_width = 16
        buffer = bytes([
            0b10101010, 0b11001100,  # Row 0
            0b01010101, 0b00110011,  # Row 1
            0b11111111, 0b00000000,  # Row 2
            0b00000000, 0b11111111,  # Row 3
            0b10101010, 0b11001100,  # Row 4
            0b01010101, 0b00110011,  # Row 5
            0b11111111, 0b00000000,  # Row 6
            0b00000000, 0b11111111,  # Row 7
        ])
    ...
    @patch("calendarbot.display.epaper.drivers.waveshare.utils.logger")
    def test_extract_region_buffer_when_error_occurs_then_logs_error(self, mock_logger: MagicMock) -> None:
    ...
    def test_extract_region_buffer_when_region_partially_outside_then_extracts_valid_part(self) -> None:
