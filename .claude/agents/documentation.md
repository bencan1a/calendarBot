...
- **[security-agent.md](.claude/agents/security-agent.md)** - Security expertise
- **[performance-agent.md](.claude/agents/performance-agent.md)** - Performance optimization
- **[ics-calendar-agent.md](.claude/agents/ics-calendar-agent.md)** - Calendar processing expertise
